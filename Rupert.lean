...
-/
 ...
 intro inner_shadow outer_shadow x x_in_closure_inner_shadow

 have closed : closure inner_shadow = inner_shadow := sorry
 rw [closed] at x_in_closure_inner_shadow
 let ⟨y, ⟨y_in_square, proj_rot_y_eq_x ⟩⟩ := x_in_closure_inner_shadow
